      ...
      <div className="heading">
        <div className="policyName">
          <div className="name">
            ...
            <div>
              <h2>Axis Bluechip Fund Direct Plan Growth</h2>
            </div>
          </div>
        ...
        <div className="yearReturn">
          <div className="percentReturn">
            {' '}
            <h2>6.76 %</h2>{' '}
          </div>
          <div className="oneYearReturn">
            {' '}
            <h6> 1 Year Return </h6>{' '}
          </div>
        </div>
      ...
      <div className="fundDetails">
        <div className="lhsDetails">
          <ul className="collection">
            <li className="collection-item">
              {' '}
              <div>Risk</div> <div>Moderately High</div>{' '}
            </li>
            <li className="collection-item">
              {' '}
              <div>Min SIP Amount</div> <div>₹500</div>{' '}
            </li>
            <li className="collection-item">
              {' '}
              <div>Expense Ratio</div> <div>0.43%</div>{' '}
            </li>
          </ul>
        </div>
        <div className="rhsDetails">
          <ul className="collection">
            <li className="collection-item">
              {' '}
              <div>NAV</div> <div>₹33.36 (28 Jul 2020)</div>{' '}
            </li>
            <li className="collection-item">
              {' '}
              <div>Fund Started</div> <div>01 Jan 2013</div>{' '}
            </li>
            <li className="collection-item">
              {' '}
              <div>Fund Size</div> <div>₹14,522 Cr</div>{' '}
            </li>
          </ul>
        </div>
      </div>
